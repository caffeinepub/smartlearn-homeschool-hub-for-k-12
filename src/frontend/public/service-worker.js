const CACHE_NAME = 'homeschool-hub-v1';
const STATIC_CACHE = 'homeschool-hub-static-v1';
const DYNAMIC_CACHE = 'homeschool-hub-dynamic-v1';
...
self.addEventListener('fetch', (event) => {
  ...
  // Skip API calls to Internet Computer backend (network-first)
